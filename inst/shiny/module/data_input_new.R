                ...
                column(width = 2,
                       box(title="Upload Raw Data:",solidHeader=TRUE, status='primary',width = 12,
                           ...
                           column(width = 12,
                                  ...
                                  tags$br(),
                                  shinyjs::hidden(actionBttn(ns("toAnalyze"), "Next QC",style = "unite",color = "royal",
    ...
    function(input, output, session, fileRoot = NULL) {
      ...
      dataModal <- function(failed = FALSE) {
        ...
        modalDialog(
          ...
          tags$hr(),
          materialSwitch(inputId = ns("modal_metadata_switch"),
                         label = "Show example annotation file", status = "danger",value = FALSE ),
