              ...
              column(width = 2,
                     ...
                     conditionalPanel(
                       ...
                       selectInput(ns("corxn_method_exprsn"), label = "Choose batch effect correction method:", choices = c("BASiCS" = "bas",
                                                                                                                            ...
                                                                                                                            "Scanorama" = "sca"), selected = "lima" ), ns = NS(id) 
                     ...
                     actionBttn(ns("correct_batch"),label="Apply",style = "jelly",color = "success",icon = icon("sliders")),
                     tags$br(),
                     tags$br(),
                     downloadBttn(ns('batch_corrct_data'), '.rds batch corrected data', color = "royal"),
                     style = " background-color: #CEECF5; border: 3px solid #CEECF5;"
